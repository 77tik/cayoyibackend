...
// Client（Filer or curl）
//    ↓
//VolumeServer.ReadNeedle
//    ↓
//ec_volume_reader.ReadNeedle
//    ↓
//EcVolume.LocateEcShardNeedle → ecx 查 needle 位置信息
//    ↓
//LocateData → 计算数据在 shard 中的偏移与大小
//    ↓
//Shard 读取数据（本地读取 or 远程拉取）
//    ↓
//Reed-Solomon 解码还原 needle 数据
//    ↓
//返回给客户端
